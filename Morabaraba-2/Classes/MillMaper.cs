...
namespace Morabaraba_2.Helpers
{
   ...
   public class MillMaper
   {
        ...
        private void GenerateMills()
        {
            ...
            PossibleMills.Add(new Mills { IndexOnBoard=0,AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
            ...
            PossibleMills.Add(new Mills { IndexOnBoard = 1, AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
            ...
            PossibleMills.Add(new Mills { IndexOnBoard = 2, AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
            ...
            PossibleMills.Add(new Mills { IndexOnBoard = 3, AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
            ...
            Adjacent.Add(new Tuple<Cow, Cow, Cow>(new Cow { CowType = temp, IndexonBoard = 3 }, new Cow { CowType = temp, IndexonBoard = 5 }, new Cow { CowType = temp, IndexonBoard = 4 }));
            PossibleMills.Add(new Mills { IndexOnBoard = 4, AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
            ...
            PossibleMills.Add(new Mills { IndexOnBoard = 5, AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
            ...
            PossibleMills.Add(new Mills { IndexOnBoard = 6, AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
            ...
            PossibleMills.Add(new Mills { IndexOnBoard = 7, AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
            ...
            PossibleMills.Add(new Mills { IndexOnBoard = 8, AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
            ...
            PossibleMills.Add(new Mills { IndexOnBoard = 9, AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
            ...
            PossibleMills.Add(new Mills { IndexOnBoard = 10, AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
            ...
            PossibleMills.Add(new Mills { IndexOnBoard = 11, AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
            ...
            PossibleMills.Add(new Mills { IndexOnBoard = 12, AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
            ...
            PossibleMills.Add(new Mills { IndexOnBoard = 13, AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
            ...
            PossibleMills.Add(new Mills { IndexOnBoard = 14, AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
            ...
            PossibleMills.Add(new Mills { IndexOnBoard = 15, AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
            ...
            PossibleMills.Add(new Mills { IndexOnBoard = 16, AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
            ...
            PossibleMills.Add(new Mills { IndexOnBoard = 17, AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
            ...
            PossibleMills.Add(new Mills { IndexOnBoard = 18, AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
            ...
            PossibleMills.Add(new Mills { IndexOnBoard = 19, AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
            ...
            PossibleMills.Add(new Mills { IndexOnBoard = 20, AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
            ...
            PossibleMills.Add(new Mills { IndexOnBoard = 21, AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
            ...
            PossibleMills.Add(new Mills { IndexOnBoard = 22, AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
            ...
            PossibleMills.Add(new Mills { IndexOnBoard = 23, AdjacentMills = Adjacent });
            Adjacent = new List<Tuple<Cow, Cow, Cow>>();
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public List<Mills> GetAdjacentMills()
        {
