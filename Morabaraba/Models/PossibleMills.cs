...
namespace MorabarabaNS.Models
{
   ...
   public class PossibleMills
   {
        ...
        {
            AllPossibleMills = new List<IMills>();
    
            List<IMill> Adjacent = new List<IMill>();
        ...
        /// </summary>
        /// <returns></returns>
        public IMills GetMillsByIndex(int index)
        {
